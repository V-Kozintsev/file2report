## Проект easy2report разработан на стеке Laravel с использованием среды разработки Homestead, с подключением SMTP для Яндекс.Почты, что обеспечивает отправку писем через внешний почтовый сервис. Кроме этого, проект развернут и работает на виртуальном хостинге Timeweb, что позволяет использовать его в рабочем режиме с полноценной серверной инфраструктурой.
