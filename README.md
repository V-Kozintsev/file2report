Проект easy2report разработан на стеке Laravel с использованием среды разработки Homestead, с подключением SMTP для Яндекс.Почты, что обеспечивает отправку писем через внешний почтовый сервис.
